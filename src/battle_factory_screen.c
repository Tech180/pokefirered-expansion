...
static void Select_Task_OpenSummaryScreen(u8 taskId)
{
    ...
    case STATE_SUMMARY_SHOW:
        ...
        ShowPokemonSummaryScreen(sFactorySelectMons, currMonId, SELECTABLE_MONS_COUNT - 1, CB2_InitSelectScreen, PSS_MODE_NORMAL);
        break;
    }
}
...
static void Swap_Task_OpenSummaryScreen(u8 taskId)
{
    ...
    case STATE_SUMMARY_SHOW:
        ...
        ShowPokemonSummaryScreen(gPlayerParty, sFactorySwapScreen->cursorPos, FRONTIER_PARTY_SIZE - 1, CB2_InitSwapScreen, PSS_MODE_NORMAL);
        break;
    }
}
