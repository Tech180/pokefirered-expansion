...
static void ShowSafariBallsWindow(void)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_Bag);
...
#if 0 // Uncomment the calls in Task_HeatStartMenu_HandleMainInput to enable
...
static const u8 gText_Pokedex_Heat[] = _("  Pokédex");
static const u8 gText_Party_Heat[]   = _("    Party ");
static const u8 gText_Bag_Heat[]     = _("      Bag  ");
...
static void HeatStartMenu_UpdateMenuName(void) {
  ...
  switch(menuSelected) {
    case MENU_POKETCH:
      ...
      break;
    case MENU_POKEDEX:
      AddTextPrinterParameterized(sHeatStartMenu->sMenuNameWindowId, 1, gText_Pokedex_Heat, 1, 0, 0xFF, NULL);
      break;
    case MENU_PARTY:
      AddTextPrinterParameterized(sHeatStartMenu->sMenuNameWindowId, 1, gText_Party_Heat, 1, 0, 0xFF, NULL);
      break;
    case MENU_BAG:
      AddTextPrinterParameterized(sHeatStartMenu->sMenuNameWindowId, 1, gText_Bag_Heat, 1, 0, 0xFF, NULL);
      break;
    case MENU_TRAINER_CARD:
      AddTextPrinterParameterized(sHeatStartMenu->sMenuNameWindowId, 1, gText_Trainer, 1, 0, 0xFF, NULL);
      break;
    case MENU_SAVE:
      AddTextPrinterParameterized(sHeatStartMenu->sMenuNameWindowId, 1, gText_Save_Heat, 1, 0, 0xFF, NULL);
      break;
    case MENU_OPTIONS:
...
static u8 SaveDoSaveCallback(void)
{
    ...
    if (saveStatus == SAVE_STATUS_OK)
        ...
        ShowSaveMessage(sText_SaveError, SaveErrorCallback);
...
static void ShowSaveInfoWindow(void) {
    ...
    // Print player name
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_Player, 0, yOffset, TEXT_SKIP_DRAW, NULL);
    ...
    // Print badge count
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_Badges, 0, yOffset, TEXT_SKIP_DRAW, NULL);
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        // Print pokedex count
        yOffset += 16;
        AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_Pokedex, 0, yOffset, TEXT_SKIP_DRAW, NULL);
        BufferSaveMenuText(SAVE_MENU_POKEDEX, gStringVar4, color);
        xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar4, 0x70);
        AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVar4, xOffset, yOffset, TEXT_SKIP_DRAW, NULL);
    }
    ...
    // Print play time
    yOffset += 16;
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gText_Time, 0, yOffset, TEXT_SKIP_DRAW, NULL);
    BufferSaveMenuText(SAVE_MENU_TIME, gStringVar4, color);
    xOffset = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar4, 0x70);
    AddTextPrinterParameterized(sSaveInfoWindowId, FONT_NORMAL, gStringVar4, xOffset, yOffset, TEXT_SKIP_DRAW, NULL);
