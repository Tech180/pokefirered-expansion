...
// Each 4 KiB flash sector contains 3896 bytes of actual data followed by 188 bytes of SaveBlock3 and then 12 bytes of footer.
#define SECTOR_DATA_SIZE 3896
#define SAVE_BLOCK_3_CHUNK_SIZE 188
