...
#define OW_SEASONS                      (gSaveBlock2Ptr->optionsSeasons)         // Enables seasonal tilesets
#define OW_SEASON_ENCOUNTERS            TRUE
...
#define OW_FIELD_MOVES_REQUIRE_HM_ITEM  TRUE    // If TRUE, using field moves in the overworld also requires having the corresponding HM item in the bag (for use with OW_FIELD_MOVES_WITHOUT_HMS).
