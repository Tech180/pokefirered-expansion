...
// Flag/var defines
#define DN_FLAG_SEARCHING             0x110 // Searching for mon
#define DN_FLAG_DEXNAV_GET            0x111 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         0x112 // Allow player to find hidden mons
