...
// Quest State Vars
#define VAR_STATE_QUEST_THE_TREASURE_HUNTER      0x4092
#define VAR_STATE_QUEST_SLEEPING_ON_THE_JOB      0x4093
#define VAR_STATE_QUEST_REST_IN_PEACE            0x4094
#define VAR_STATE_QUEST_THE_GYM_INSPECTOR        0x4095
#define VAR_STATE_QUEST_VENDING_MACHINE_ROULETTE 0x4096
#define VAR_STATE_QUEST_THE_GRAND_BLUE_MILE      0x4097
#define VAR_STATE_QUEST_ROCK_AND_STONE           0x4098
#define VAR_STATE_QUEST_THE_SAFARI_PURIST        0x4099
#define VAR_STATE_QUEST_MUTUAL_ASSURANCE         0x409a
#define VAR_STATE_QUEST_THE_FOSSIL_FANATIC       0x409b
#define VAR_STATE_QUEST_THE_HOARDER              0x409c
#define VAR_STATE_QUEST_THE_SEASICK_SAILOR       0x409d
#define VAR_STATE_QUEST_FUCHSIA_ZOO_SIGNAGE      0x409e
#define VAR_STATE_QUEST_EMF_LEVEL_5              0x409f
#define VAR_STATE_QUEST_SPACE_EXHIBIT_VANDALISM  0x40a0
#define VAR_STATE_QUEST_COMPREHENSIVE_COVERAGE   0x40a1
#define VAR_STATE_QUEST_THE_S_S_ANNE_TRUCK       0x40a2
#define VAR_STATE_QUEST_ROUTE_1_LEDGE_MASTER     0x40a3
#define VAR_STATE_QUEST_CYCLING_ROAD_SPEED_TRAP  0x40a4
#define VAR_STATE_QUEST_THE_REPEL_MASTER         0x40a5
#define VAR_STATE_QUEST_THE_EEVEE_SCHOLAR        0x40a6
#define VAR_STATE_QUEST_SILPH_CO_NAPTIME         0x40a7
#define VAR_STATE_QUEST_SCAVENGER                0x40a8
#define VAR_STATE_QUEST_BIKE_SHOP_REBELLION      0x40a9
#define VAR_STATE_QUEST_SAFARI_SPEEDRUNNER       0x40bd
#define VAR_STATE_QUEST_FUCHSIA_INVISIBLE_WALLS  0x40be
#define VAR_STATE_QUEST_THE_COUCH_POTATO         0x40bf
#define VAR_STATE_QUEST_CONSOLE_WARS             0x40c0
#define VAR_STATE_QUEST_DEFORESTATION            0x40c1
#define VAR_STATE_QUEST_BOULDER_BUSTER           0x40c2
#define VAR_STATE_QUEST_THIRSTY_WORK             0x40c3
#define VAR_STATE_QUEST_PLUSH_COLLECTOR          0x40c4
#define VAR_STATE_QUEST_BIRD_WATCHER             0x40c5
#define VAR_STATE_QUEST_BROKE_DESPERATE          0x40c6
#define VAR_STATE_QUEST_CERULEAN_BIKE_LOOPHOLE   0x40c7
#define VAR_STATE_QUEST_SCIENCE_IS_AMAZING       0x40c8
#define VAR_STATE_QUEST_THE_JACKPOT              0x40c9
#define VAR_STATE_QUEST_DUMPSTER_DIVER           0x40ca
#define VAR_STATE_QUEST_LORE_HISTORIAN           0x40cb
#define VAR_STATE_QUEST_PARANORMAL_INVESTIGATOR  0x40cc
#define VAR_STATE_QUEST_PIKACHU_S_BEACH          0x40cd
#define VAR_STATE_QUEST_FISHING_GURU_REUNION     0x40d2
#define VAR_STATE_QUEST_THE_COPYCAT_S_MIMIC      0x40d3
#define VAR_STATE_QUEST_BERRY_BLENDER            0x40d4
#define VAR_STATE_QUEST_LORELEI_S_MENAGERIE      0x40d5
#define VAR_STATE_QUEST_THE_TANOBY_DECIPHERER    0x40d6
#define VAR_STATE_QUEST_LOST_IN_THE_FOG          0x40d7
#define VAR_STATE_QUEST_THE_TIME_TRAVELER        0x40d8
#define VAR_STATE_QUEST_GENETIC_MEMORY           0x40d9
#define VAR_STATE_QUEST_DE_EXTINCTION_EXPERT     0x40da
#define VAR_STATE_QUEST_THE_PERFECTIONIST        0x40db
#define VAR_STATE_QUEST_THE_PACIFIST             0x40dc
#define VAR_STATE_QUEST_THE_INVISIBLE_PC         0x40dd
#define VAR_STATE_QUEST_RUBBER_DUCK_DEBUGGING    0x40de
#define VAR_STATE_QUEST_THE_MAGIKARP_SWINDLE     0x40df
#define VAR_STATE_QUEST_THE_UNUSED_BED           0x40e0
#define VAR_STATE_QUEST_LEAVE_NO_DWARF_BEHIND    0x40e1
#define VAR_STATE_QUEST_VERMILION_CONSTRUCTION   0x40e2
#define VAR_STATE_QUEST_THE_WARDEN_S_MESS        0x40e3
#define VAR_STATE_QUEST_GIOVANNI_S_THRONE        0x40e4
#define VAR_STATE_QUEST_THE_HYPNOTIZED_PATIENT   0x40e5
#define VAR_STATE_QUEST_THE_THIRSTY_GUARDS       0x40ec
#define VAR_STATE_QUEST_SAFFRON_CLUB_NATURES     0x40ed
#define VAR_STATE_QUEST_THE_FOSSILIZED_MUD       0x40ee
#define VAR_STATE_QUEST_CINNABAR_TRADE_REGRET    0x40ef
#define VAR_STATE_QUEST_CINNABAR_COASTLINE       0x40f0
#define VAR_STATE_QUEST_BILL_S_GARDEN_RUMOR      0x40f2
#define VAR_STATE_QUEST_SS_ANNE_DEPARTURE_SKIP   0x40f3
#define VAR_STATE_QUEST_THE_BLANK_SLATE          0x40f4
#define VAR_STATE_QUEST_THE_ALCHEMIST_S_TRASH    0x40f5
#define VAR_STATE_QUEST_THE_WITCHING_HOUR        0x40f6
#define VAR_STATE_QUEST_MORNING_DEW              0x40f7
#define VAR_STATE_QUEST_HIGH_TIDE_AT_SEAFOAM     0x40f8
#define VAR_STATE_QUEST_THIRSTY_GIRL_S_SECRET    0x40f9
#define VAR_STATE_QUEST_THE_SCULPTOR_S_MUSE      0x40fa
#define VAR_STATE_QUEST_THE_IMPOSTER_SYNDROME    0x40fb
#define VAR_STATE_QUEST_THE_ICE_SKATER           0x40fc
#define VAR_STATE_QUEST_THE_PEWTER_GEOLOGIST     0x40fd
#define VAR_STATE_QUEST_OAK_S_INBOX              0x40fe
#define VAR_STATE_QUEST_CINNABAR_ARCHIVIST       0x40ff
#define VAR_STATE_QUEST_PERFECT_FRIENDSHIP       0x4100
#define VAR_STATE_QUEST_TRAINER_TOWER_PACIFISM   0x4101
#define VAR_STATE_QUEST_THE_TANOBY_CIPHER        0x4102
#define VAR_STATE_QUEST_MT_EMBER_S_CORE          0x4103
#define VAR_STATE_QUEST_ICEFALL_WATERFALL        0x4104
