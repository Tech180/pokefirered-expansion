...
for line in lines:
    ...
    # Purchase History
    if line.strip() == 'void ClearItemPurchases(void)' or line.strip() == 'void ClearItemPurchases(void) {':
        skip_decor_func = True
        decor_func_brace_level = 0
        line = 'void ClearItemPurchases(void){}\n'
        new_lines.append(line)
        continue
    if line.strip() == 'static void RecordItemPurchase(u8 taskId)' or line.strip() == 'static void RecordItemPurchase(u8 taskId) {':
        skip_decor_func = True
        decor_func_brace_level = 0
